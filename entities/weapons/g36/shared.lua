...
if CLIENT then
	...
	killicon.AddFont("G36", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_G36.Single")
...
SWEP.MinRecoil		= 0.1
SWEP.MaxRecoil		= 0.4
SWEP.DeltaRecoil	= 0.07 -- The recoil to add each shot.  Same deal for spread and spray.
...
SWEP.IronSightsPos = Vector (3.9421, -2.6281, 1.1102)
SWEP.IronSightsAng = Vector (-0.0936, 0.0606, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_g36.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_g36.mdl"
