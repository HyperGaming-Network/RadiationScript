...
if CLIENT then
	...
	killicon.AddFont("Makarov PM", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
SWEP.MuzzleVelocity			= 315 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.IronSightsPos = Vector (4.7479, -4.7074, 2.6417)
SWEP.IronSightsAng = Vector (1.1397, -0.0572, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_makarov.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_makarov.mdl"
...
SWEP.AutoRPM				= 400
SWEP.SemiRPM				= 400
SWEP.BurstRPM				= 400 -- Burst RPM affects the space between the shots during the burst.  The space between bursts is determined by SemiRPM.
...
function DroponDeath()
 ...
 hook.Add( "PlayerDeath", "playerDeathTest", DroponDeath );  
