...
if CLIENT then
	...
	killicon.AddFont("Mossberg 500", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_W1300.Single")
SWEP.Primary.Damage			= 3 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 12
SWEP.Primary.ClipSize		= 6
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "buckshot"
SWEP.MuzzleVelocity			= 750 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.IronSightsPos = Vector (2.5557, -2.8084, 1.2963)
SWEP.IronSightsAng = Vector (2.9065, -2.6139, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_w1300.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_w1300.mdl"
...
SWEP.ShotgunRPM 								= 60 -- We can define our own variables for this firemode if we so desire
...
SWEP.FireModes.Shotgun.InitFunction = function(self)
	...
	self.Primary.Sound			= Sound("Weapon_W1300.Single")
