...
if CLIENT then
	...
	killicon.AddFont("F2000", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
SWEP.MuzzleVelocity			= 910 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.MinRecoil		= 0.1
SWEP.MaxRecoil		= 0.2
SWEP.DeltaRecoil	= 0.01 -- The recoil to add each shot.  Same deal for spread and spray.
...
SWEP.IronSightsPos = Vector (3.6064, -3.2816, 0.8119)
SWEP.IronSightsAng = Vector (9.6681, 0.9096, 0)
...
SWEP.CrouchModifier		= 1.3 -- Applies if player is crouching.
