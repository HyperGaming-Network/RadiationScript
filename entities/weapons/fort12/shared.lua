...
if CLIENT then
	...
	killicon.AddFont("Fort 12", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_Fort12.Single")
SWEP.Primary.Damage			= 9 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 12
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "pistol"
SWEP.MuzzleVelocity			= 320 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.IronSightsPos = Vector (2.8155, -4.6369, 1.699)
SWEP.IronSightsAng = Vector (-0.0396, -0.0287, 0)
