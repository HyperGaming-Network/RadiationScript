...
if CLIENT then
	...
	killicon.AddFont("SVD", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_SVD.Single")
...
SWEP.IronSightsPos = Vector (4.578, -2.8964, 2.0329)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_svd.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_svd.mdl"
