...
if CLIENT then
	...
	killicon.AddFont("AKS-74u", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_AK74u.Single")
SWEP.Primary.Damage			= 13 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 30
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "smg1"
SWEP.MuzzleVelocity			= 735 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.MinSpread		= 0.004
SWEP.MaxSpread		= 0.07
SWEP.DeltaSpread	= 0.006
...
SWEP.IronSightsPos = Vector (3.065, -3.0756, 1.2452)
SWEP.IronSightsAng = Vector (1.468, -0.0887, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_ak74u.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_ak74u.mdl"
