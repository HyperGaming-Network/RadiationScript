...
if CLIENT then
	...
	killicon.AddFont("Walther P99", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
SWEP.Primary.Damage			= 12 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 16
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "XBowBolt"
SWEP.MuzzleVelocity			= 408 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.IronSightsPos = Vector (4.3171, -3.4599, 2.4704)
SWEP.IronSightsAng = Vector (2.108, -0.0363, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_p99.mdl"
