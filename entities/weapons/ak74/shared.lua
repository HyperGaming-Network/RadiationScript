...
SWEP.IronSightsPos = Vector (4.8663, -4.0234, 2.1935)
SWEP.IronSightsAng = Vector (1.0618, -1.3337, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_ak74.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_ak74.mdl"
