...
if CLIENT then
	...
	killicon.AddFont("VSS Vintorez", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_Vintorez.Single")
SWEP.Primary.Damage			= 18 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 20
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "Slam"
SWEP.MuzzleVelocity			= 290 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.MinRecoil		= 0.2
SWEP.MaxRecoil		= 0.7
SWEP.DeltaRecoil	= 0.08 -- The recoil to add each shot.  Same deal for spread and spray.
...
SWEP.IronSightsPos = Vector (2.6498, -0.7574, 1.0786)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_vintorez.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_vintorez.mdl"
