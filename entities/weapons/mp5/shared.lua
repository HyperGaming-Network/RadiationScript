...
if CLIENT then
	...
	killicon.AddFont("MP5", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
SWEP.Primary.Damage			= 7 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 30
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "XBowBolt"
SWEP.MuzzleVelocity			= 400 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.MinRecoil		= 0.14
SWEP.MaxRecoil		= 0.7
SWEP.DeltaRecoil	= 0.155 -- The recoil to add each shot.  Same deal for spread and spray.
...
SWEP.IronSightsPos = Vector (1.9493, -1.2461, 0.2748)
SWEP.IronSightsAng = Vector (0.4902, -0.0962, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_mp5.mdl"
...
SWEP.AvailableFireModes		= {"Auto","Burst","TwoBurst","Semi"} -- What firemodes shall we use?
...
SWEP.AutoRPM				= 800
SWEP.SemiRPM				= 800
SWEP.BurstRPM				= 2400 -- Burst RPM affects the space between the shots during the burst.  The space between bursts is determined by SemiRPM.
