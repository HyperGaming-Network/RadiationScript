...
if CLIENT then
	...
	killicon.AddFont("M92FS", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
SWEP.Primary.Damage			= 9 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 15
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "pistol"
SWEP.MuzzleVelocity			= 381 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.IronSightsPos = Vector (3.0634, -2.1704, 1.1842)
SWEP.IronSightsAng = Vector (-0.4265, -0.0145, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_beretta.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_beretta.mdl"
