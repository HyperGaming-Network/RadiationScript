...
if CLIENT then
	...
	killicon.AddFont("Sig 550", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_Sig550.Single")
SWEP.Primary.Damage			= 10 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 30
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "smg1"
SWEP.MuzzleVelocity			= 980 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.MinRecoil		= 0.1
SWEP.MaxRecoil		= 0.45
SWEP.DeltaRecoil	= 0.075 -- The recoil to add each shot.  Same deal for spread and spray.

-- Spread: the width of the gun's firing cone.  More spread means less accuracy.
SWEP.MinSpread		= 0.002
SWEP.MaxSpread		= 0.045
SWEP.DeltaSpread	= 0.0035
...
SWEP.IronSightsPos = Vector (2.1849, -3.3277, 0.9423)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_sig550.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_sig550.mdl"
