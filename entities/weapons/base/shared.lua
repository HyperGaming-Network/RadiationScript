...
function SWEP:BaseAttack()
	...
	if(  self.Weapon:Clip1() <= 1 and self:Ammo1() <= 0 ) then return end
...
function SWEP:RGShootBullet(dmg, speed, spread, spray, sprayvec, numbul)
