...
if CLIENT then
	...
	killicon.AddFont("Sig P220", "CSKillIcons", SWEP.IconLetter, Color(255, 220, 0, 255))
...
-- Primary Fire --
----------------------
SWEP.Primary.Sound			= Sound("Weapon_P220.Single")
SWEP.Primary.Damage			= 14 -- This determines both the damage dealt and force applied by the bullet.
SWEP.Primary.NumShots		= 1
SWEP.Primary.ClipSize		= 7
SWEP.Primary.DefaultClip	= 1
SWEP.Primary.Ammo			= "pistol"
SWEP.MuzzleVelocity			= 297 -- How fast the bullet travels in meters per second. For reference, an AK47 shoots at about 750, an M4 shoots at about 900, and a Luger 9mm shoots at about 350 (source: Wikipedia)
...
SWEP.IronSightsPos = Vector (2.5845, -2.4487, 1.3193)
SWEP.IronSightsAng = Vector (0.3833, -0.0168, 0)
...
-- Effects/Visual --
-------------------------
SWEP.ViewModel				= "models/srp/weapons/v_p220.mdl"
SWEP.WorldModel				= "models/srp/weapons/w_p220.mdl"
