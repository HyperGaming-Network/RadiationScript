...
self.RadioSong1 = CreateSound(self.Entity,"hgn/stalker/music/freedomradio.mp3")
self.RadioSong2 = CreateSound(self.Entity,"hgn/stalker/music/banditsradio.mp3")
self.RadioSong3 = CreateSound(self.Entity,"hgn/stalker/music/dutyradio.mp3")
self.RadioSong4 = CreateSound(self.Entity,"hgn/stalker/music/marshradio.mp3")
self.RadioSong5 = CreateSound(self.Entity,"hgn/stalker/music/barradio.mp3")
