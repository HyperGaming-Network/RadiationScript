...
function PANEL:Paint()
	...
	if( self.TitleVisible ) then
		...
		draw.RoundedBox( 4, 0, 0, self:GetWide(), 25, Color( 0, 0, 0, 0 ) );
		draw.DrawText( self.Title, "Default", 2, 3, Color( 255, 255, 255, 0 ) );
	
	end
		
	draw.RoundedBox( 5, 0, 23, self:GetWide(), self:GetTall() - 23, Color( 40, 40, 40, 0 ) );
