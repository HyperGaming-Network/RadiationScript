ITEM.Name = "Brown Leather Coat";
ITEM.Class = "suit_ban2";
ITEM.Description = "Brown leather Coat";
...
ply:ConCommand("play npc/combine_soldier/zipline_clothing1.wav")
	ply:SetModel("models/srp/stalker_bandit_veteran.mdl");
...
ply:GetTable().RadiationScale = .9
	self:Remove();
RAD.SetCharField(ply, "model",("models/srp/stalker_bandit_veteran.mdl") );		
end
