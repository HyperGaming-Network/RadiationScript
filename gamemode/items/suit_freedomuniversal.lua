ITEM.Name = "PSZ-9Mf Universal Protection";
ITEM.Class = "suit_freeuniversal";
ITEM.Description = "A Duty Univeral Protection suit modified for Freedom.";
...
ply:ConCommand("play npc/combine_soldier/zipline_clothing1.wav")
	ply:SetModel("models/srp/bio_free.mdl");
...
ply:GetTable().ArtifactSlotsFilled = 0
	self:Remove();
RAD.SetCharField(ply, "model",("models/srp/bio_free.mdl") );			
end
