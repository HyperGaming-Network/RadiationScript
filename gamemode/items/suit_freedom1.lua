ITEM.Name = "Wind of Freedom Suit";
ITEM.Class = "suit_freedom1";
...
ply:GetTable().ArtifactSlotsFilled = 0
	ply:SetModel("models/srp/stalker_hood_svob.mdl");
...
ply:GetTable().RadiationScale = .5
	self:Remove();
RAD.SetCharField(ply, "model",("models/srp/stalker_hood_svob.mdl") );				
end
